...
public interface ToppingApi {
  ...
  @ApiOperation(
      value = "adds a Topping item",
      nickname = "addTopping",
      notes = "Adds an topping to the system",
      tags = {
        "topping",
      })
  @ApiResponses(
  ...
  ResponseEntity<Void> addTopping(
      @ApiParam(value = "Topping item to add") @Valid @RequestBody ToppingItem body);

  @ApiOperation(
      value = "searchs for topping",
      nickname = "searchTopping",
      notes =
          "By passing in the appropriate options, you can search for available toppings in the system ",
      response = ToppingItem.class,
  ...
  ResponseEntity<List<ToppingItem>> searchTopping(
