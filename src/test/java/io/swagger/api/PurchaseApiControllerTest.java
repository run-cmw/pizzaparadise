...
public class PurchaseApiControllerTest {
  ...
  public void testMakePurchaseOk() throws Exception {
    ...
    Card card = new Card("Mary", "Smith", "4400616718352235", 12, 2030, CardProvider.VISA);
  ...
  public void testMakePurchaseExpCard() throws Exception {
    ...
    Card card = new Card("Bob", "Smith", "4400616718352235", 12, 2000, CardProvider.VISA);
  ...
  public void testMakePurchaseInvalidCardMonth() throws Exception {
    ...
    Card card = new Card("Bob", "Smith", "4400616718352235", 13, 2025, CardProvider.VISA);
  ...
  public void testMakePurchaseCartNotFound() throws Exception {
    ...
    Card card = new Card("Mary", "Smith", "4400616718352235", 12, 2025, CardProvider.VISA);
